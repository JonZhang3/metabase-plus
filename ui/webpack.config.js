...
const ASSETS_PATH = __dirname + "/resources/app/assets";
const FONTS_PATH = __dirname + "/resources/app/fonts";
const SRC_PATH = __dirname + "/frontend/src/metabase";
const LIB_SRC_PATH = __dirname + "/frontend/src/metabase-lib";
const ENTERPRISE_SRC_PATH = __dirname + "/enterprise/frontend/src/metabase-enterprise";
...
const BUILD_PATH = path.resolve(__dirname, "../src/main/resources/static");
const HTML_PATH = path.resolve(__dirname, "../src/main/resources/templates");
...
const config = (module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: HTML_PATH + "/public.html",
            chunksSortMode: "manual",
        ...
        new CopyPlugin([
            {from: __dirname + '/resources/app/assets', to: BUILD_PATH + '/app/assets'},
            {from: __dirname + '/resources/app/fonts', to: BUILD_PATH + '/app/fonts'},
            {from: __dirname + '/resources/app/img', to: BUILD_PATH + '/app/img'},
            {from: __dirname + '/resources/app/iframeResizer.js', to: BUILD_PATH + '/app'},
        ]),
    ],
});
