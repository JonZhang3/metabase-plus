...
require("./goog.html.safestylesheet.js");
require("./goog.string.const.js");
require("./goog.structs.circularbuffer.js");
...
goog.debug.DebugWindow.prototype.openWindow_ = function() {
  ...
  this.win = window.open("", this.getWindowName_(), "width\x3d" + w + ",height\x3d" + h + ",toolbar\x3dno,resizable\x3dyes," + "scrollbars\x3dyes,left\x3d" + x + ",top\x3d" + y + ",status\x3dno,screenx\x3d" + x + ",screeny\x3d" + y);
  if (!this.win) {
...
module.exports = goog.debug.DebugWindow;
